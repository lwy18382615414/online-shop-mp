<template>
  <view class="viewport">
    ...
    <!-- 滑动容器 -->
    <swiper class="swiper" @change="onOrderTypeChange">
      <!-- 滑动项 -->
...
import { OrderState } from '../detail/constances'
...
const onOrderTypeChange: UniHelper.SwiperOnChange = async (ev) => {
...
async function onOrderPay(id: string) {
  ...
  if (import.meta.env.DEV) {
    ...
    const res = await wxPayApi({ orderId: id })
